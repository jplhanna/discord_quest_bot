...
class TestQuestService:
    async def test_accept_quest_if_available(self, mocked_user):
        # Arrange
    ...
    async def test_quest_dne(self, mocked_user):
        # Arrange
    ...
    async def test_quest_already_accepted(self, mocked_user):
        # Arrange
    ...
    async def test_quest_completed(self, mocked_user, max_completion_count):
        # Arrange
    ...
    async def test_cannot_complete_nonexistent_quest(self, mocked_user):
        # Arrange
        mock_quest_repository = AsyncMock(get_first=AsyncMock(return_value=None))
        quest_service = QuestService(quest_repository=mock_quest_repository, user_quest_repository=AsyncMock())
        # Act & Assert
    ...
    async def test_cannot_complete_unaccepted_quest(self, mocked_user):
        # Arrange
        mock_quest_repository = AsyncMock(
    ...
    async def test_max_completion_count_reached(self, mocked_user):
        # Arrange
